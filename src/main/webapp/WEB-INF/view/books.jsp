...
<main class="catalog-main main-content">
    <section class="goods container">
        <ul class="way">
            ...
            <li><a href="<%out.print(request.getContextPath());%>"><%bundle.getString("global.orders");%></a></li>
        </ul>
        ...
        <ul class="books-list users-list">
            <%
                ...
                for (Book book : books) {
                    ...
                    out.println("<a href=\"books?delete=" + book.getId() + "\">" + bundle.getString("book.delete") + "</a>");
                    ...
                    out.println("<p class=\"current-price\">" + book.getPrice() + " " + bundle.getString("hrn") + "/" + bundle.getString("hour") + "</p>");
                    out.println("</li>");
                }
            %>
        </ul>
